        ...
        <header className="w-full bg-white md:bg-transparent fixed top-0 left-0 right-0">
            <nav className={`py-4 lg:px-14 px-4 ${isSticky ? "sticky top-0 left-0 right-0 border-b bg-white duration-300" : ""}`} >
                <div className="flex justify-between items-center text-base gap-8">
                    ...
                    alt="" className="w-10 inline-block items-center" /><span className="text-[#FFC107]">Mentorship</span></a>
                    ...
                    <div className='space-x-2 hidden lg:flex items-center'>
                        <a href="./login.js" className='hiddden lg:flex items-center text-brandPrimary
